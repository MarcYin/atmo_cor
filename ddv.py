...
class ddv(object):
    ...
    def _ddv_prior(self,):
        ...
        ndvi_mask = (ndvi > 0.6) & (self.swif > 0.01) & (self.swif < 0.25) & (self.mask) & (self.nir>=0.0001) & (self.red>=0.0001)
